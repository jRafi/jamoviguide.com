...
1. To perform a linear regression you need two continuous variables: one outcome variable and one predictor variable. Therefore, your data should look something like this:  
...
1. To perform a logistic regression you need a continuous predictor variable and a categorical outcome variable. Therefore, your data should look something like this:  
