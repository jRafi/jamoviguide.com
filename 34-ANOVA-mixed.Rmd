...
1. You need one grouping variable with two levels (e.g. treatment/control) and one continuous outcome variable for each measurement occassion. Make sure that the grouping variable is marked with <img src="images/icons/nominal.JPG" width="3%" alt=" grouped data icon"/> and the continuous variables are marked with <img src="images/icons/continuous.JPG" width="3%" alt=" the continuous data icon"/> (see section \@ref(level-of-measurement)).  
